...
import type { Board, Column, Card, Label, User } from '../types';
...
interface BoardState {
  ...
  shareBoard: (boardId: string, userId: string) => Promise<void>;
  unshareBoard: (boardId: string, userId: string) => Promise<void>;
  shareColumn: (boardId: string, columnId: string, userId: string) => Promise<void>;
  unshareColumn: (boardId: string, columnId: string, userId: string) => Promise<void>;
  shareCard: (boardId: string, columnId: string, cardId: string, userId: string) => Promise<void>;
...
export const useBoardStore = create<BoardState>((set, get) => ({
  ...
  shareBoard: async (boardId: string, userId: string) => {
    try {
      const { board } = await api.boards.share(boardId, userId);
      const normalizedBoard = ensureColumns(board);
  ...
  shareColumn: async (boardId: string, columnId: string, userId: string) => {
    try {
      const { board } = await api.boards.shareColumn(boardId, columnId, userId);
      const normalizedBoard = ensureColumns(board);
  ...
  shareCard: async (boardId: string, columnId: string, cardId: string, userId: string) => {
    try {
      const { board } = await api.boards.shareCard(boardId, columnId, cardId, userId);
      const normalizedBoard = ensureColumns(board);
